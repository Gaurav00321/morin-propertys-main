    ...
    <main id="main-content" className="min-h-screen">
      ...
      <section className="hero-section hero-section--page bg-brand-primary min-h-[40vh] md:min-h-[50vh] flex items-center justify-center relative overflow-hidden">
        ...
        <div className=" relative z-20 text-center w-full px-4">
          ...
          <p className="text-white drop-shadow-md text-lg mt-4">Be part of Vadodara&apos;s fastest-growing real estate team</p>
        </div>
      </section>
      ...
      <section className="py-16 md:py-24 bg-white">
        <div className="section-container">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map(b => (
              <div key={b.title} className="card p-6 !rounded-2xl text-center">
                <div className="w-14 h-14 rounded-full bg-brand-secondary/10 flex items-center justify-center mx-auto mb-4">
      ...
      <section className="py-16 md:py-24 bg-brand-light">
        <div className="section-container max-w-3xl mx-auto">
          ...
          <div className="space-y-4">
            {roles.map(role => (
              <div key={role.title} className="card p-6 !rounded-2xl flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
